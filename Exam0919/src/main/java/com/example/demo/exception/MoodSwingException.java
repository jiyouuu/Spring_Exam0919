...
@NoArgsConstructor
public class MoodSwingException extends RuntimeException{
	// 토심이 기분이 나쁠 때 발생하는 예외 
	...
	public MoodSwingException(String message) {
		super(message);
	}
		
	// 메세지 + 원인(exception)을 받는 생성자
	public MoodSwingException(String message, Throwable cause) {
		super(message, cause);
	}
		
	// 원인(exception)만 받는 생성자
	public MoodSwingException(Throwable cause) {
		super(cause);
	}
}
